...
import 'package:fitness_storm/Screen/Trainee%20Screens/Conversation/conversation_screen.dart';
  ...
  List<GetPage> getPages() {
    return [
      ...
      GetPage(
          ...
          page: () => const LoadingStartTrainginScreen(),
          binding: LoadingStartTraingingBinding()),
      GetPage(
          name: AppRoutes.filterScreen,
          page: () => const FilterPageScreen(),
