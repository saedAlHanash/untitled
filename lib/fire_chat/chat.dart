...
import 'package:chat_web_app/chat_service/core/firebase_chat_core.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: BlocBuilder<MessagesCubit, MessagesInitial>(
          buildWhen: (p, c) => c.mRequest.id == widget.room.id&&c.result.length!=p.result.length,
          builder: (context, state) {
            ...
            return Chat(
              ...
              theme: const DarkChatTheme(
                ...
                secondaryColor: mainColorDark,
                inputBackgroundColor: mainColor,
              ),
              customBottomWidget:
              widget.room.me != null ? null : const SizedBox(),
